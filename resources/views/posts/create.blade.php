                ...
                <div class="p-2 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="flex gap-4 items-center shadow-sm pb-4">
                            <x-avatar :src="Auth::user()->profile_photo" :alt="Auth::user()->username" />
                        ...
                        <div class="overflow-y-auto h-72">
                            <x-text-textarea id="content" name="content"
                                ...
                                placeholder="Quoi de neuf, {{ Auth::user()->username }} ?">
                            </x-text-textarea>
                            <img id="post_img_preview" class="hidden" src="https://placehold.co/192"
                                alt="{{ Auth::user()->username . "'s post" }}">
                        </div>
